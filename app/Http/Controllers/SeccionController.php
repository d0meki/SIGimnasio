...
class SeccionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.secciones.index', compact('tag'))->with('info','Se Creo Exitosamente!!');
    }
    ...
    {
        $tag->delete();
        return redirect()->route('admin.secciones.index')->with('info','Se elimino Exitosamente!!');
    }
}
